...
let g:go_fmt_options = '-local compass.com/,github.com/UrbanCompass/'
let g:go_fmt_experimental = 1 " preserves folds on save

" Linting
let g:go_metalinter_autosave = 0
"let g:go_metalinter_autosave_enabled = ['golangci-lint', 'gofmt', 'deadcode', 'vetshadow', 'gosimple', 'goconst', 'errcheck']
"let g:go_metalinter_enabled = ['golint', 'gofmt', 'deadcode', 'vetshadow', 'gosimple', 'goconst', 'errcheck']
